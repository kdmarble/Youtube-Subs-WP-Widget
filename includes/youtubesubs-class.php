...
class Youtube_Subs_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			array( 'description' => esc_html__( 'Widget to display Youtube Sub count and button', 'yts_domain' ), ) // Args
		);
	}
	...
	public function form( $instance ) {
        ...
        $layout = ! empty( $instance['layout'] ) ? $instance['layout'] : esc_html__( 'Layout Option', 'yts_domain' );
        
        $count = ! empty( $instance['count'] ) ? $instance['count'] : esc_html__( 'Count Option', 'yts_domain' );
		...
		<input 
        class="widefat" 
        id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" 
		...
		<input 
        class="widefat" 
        id="<?php echo esc_attr( $this->get_field_id( 'channel' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'channel' ) ); ?>" 
		...
		<select 
        class="widefat" 
        id="<?php echo esc_attr( $this->get_field_id( 'layout' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'layout' ) ); ?>">
		...
		<select 
        class="widefat" 
        id="<?php echo esc_attr( $this->get_field_id( 'count' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'count' ) ); ?>">
